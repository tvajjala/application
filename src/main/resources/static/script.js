$(function() {
  var springfox = {
    "baseUrl": function() {
      var urlMatches = /(.*)\/api-console.*/.exec(window.location.href);
      return urlMatches[1];
    },
  ...
  window.oAuthRedirectUrl = springfox.baseUrl() + '/o2c';
  ...
  window.springfox.uiConfig(function(data) {
    ...
    //Below events useful without clicking on button 
  ...
  //  $('#input_password').change(addAuthorization);
    ...
    function addAuthorization() {
        ...
        if ( usernameVal && usernameVal.trim() != "" && passwordVal && passwordVal.trim() != "") {
            
        	var dataJSON={username:usernameVal,password:passwordVal};
        	...
        	$.ajax({
                ...
                success: function( data, textStatus, jQxhr ){
                 ...
                 var authorization= JSON.parse(data).accessToken;
                 console.log(authorization);
                 
                 var apiKeyAuth = new SwaggerClient.ApiKeyAuthorization(window.apiKeyName, authorization, window.apiKeyVehicle);
                 window.swaggerUi.api.clientAuthorizations.add(window.apiKeyName, apiKeyAuth);
            ...
            console.log(username+" : "+password+" : "+basicAuth);
